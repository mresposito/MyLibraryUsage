...
LIB_DIR      = os.path.join( DB_DIR     , "libraries"   )
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(DB_DIR,'users.db'),           # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wft9=)_4+cwi8v=&amp;y6l_w1-qs3-n%+2y74q2+&amp;uvjix8ygtsaz'
